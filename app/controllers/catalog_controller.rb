...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field 'in_cycle_ssi', label: 'Request Cycle'
    ...
    config.add_show_field 'activity_type_ssi', label: 'Type'
    config.add_show_field 'card_type_ssi', label: 'Category'
    ...
    #config.add_show_field 'prev_work_tsi', label: 'Previous Work'

    #config.add_show_field 'accomplish_ssim', label: 'Accomplished'
    #config.add_show_field 'benefits_ssim', label: 'Benefits'
    #config.add_show_field 'at_stake_ssim', label: 'At Stake'
    #config.add_show_field 'ext_pressure_ssim', label: 'External Pressure'
    #config.add_show_field 'non_tech_ssim', label: 'Non-Technical'
    #config.add_show_field 'time_constraints_ssim', label: 'Time Constraints'
    ...
    config.add_show_field 'ext_link_ssi', label: 'External Link'
    ...
    config.add_show_field 'other_contacts_ssim', label: 'Other Contacts'
