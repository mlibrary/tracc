...
Track.create(card_id:'7',epic_title: 'Website Redesign',track: 'Project-Level', status: 0)
Track.create(card_id:'8',epic_title: 'Hathi Trust',track: 'Project-Level', status: 0)
